...
var ASM_CONSTS = {
 ...
 6144850: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 6144933: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 6145002: () => { return window.innerWidth; },  
 6145032: () => { return window.innerHeight; }
};
